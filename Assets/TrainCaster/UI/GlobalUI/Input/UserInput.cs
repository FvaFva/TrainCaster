...
//     version 1.7.0
//     from Assets/TrainCaster/UI/GlobalUI/Input/UserInput.inputactions
//
...
public partial class @UserInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""SystemSource"",
            ""id"": ""53a79673-e9f2-4aa2-82fa-d93a78c861f8"",
            ""actions"": [
                {
                    ""name"": ""CoursorPosition"",
                    ""type"": ""Value"",
                    ""id"": ""c3f51692-7284-43d2-977f-cffc31bf192c"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""48c2a5e1-7bc5-41a9-92f3-76ff8deab9f1"",
                    ""path"": ""<Mouse>/position"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Mouse Keyboard"",
    ...
    ""controlSchemes"": [
        ...
        // SystemSource
        m_SystemSource = asset.FindActionMap("SystemSource", throwIfNotFound: true);
        m_SystemSource_CoursorPosition = m_SystemSource.FindAction("CoursorPosition", throwIfNotFound: true);
    }
    ...
    // SystemSource
    private readonly InputActionMap m_SystemSource;
    private List<ISystemSourceActions> m_SystemSourceActionsCallbackInterfaces = new List<ISystemSourceActions>();
    private readonly InputAction m_SystemSource_CoursorPosition;
    public struct SystemSourceActions
    {
        private @UserInput m_Wrapper;
        public SystemSourceActions(@UserInput wrapper) { m_Wrapper = wrapper; }
        public InputAction @CoursorPosition => m_Wrapper.m_SystemSource_CoursorPosition;
        public InputActionMap Get() { return m_Wrapper.m_SystemSource; }
        public void Enable() { Get().Enable(); }
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(SystemSourceActions set) { return set.Get(); }
        public void AddCallbacks(ISystemSourceActions instance)
        {
            if (instance == null || m_Wrapper.m_SystemSourceActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_SystemSourceActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(ISystemSourceActions instance)
        {
            @CoursorPosition.started -= instance.OnCoursorPosition;
            @CoursorPosition.performed -= instance.OnCoursorPosition;
            @CoursorPosition.canceled -= instance.OnCoursorPosition;
        ...
        public void RemoveCallbacks(ISystemSourceActions instance)
        {
            if (m_Wrapper.m_SystemSourceActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(ISystemSourceActions instance)
        {
            foreach (var item in m_Wrapper.m_SystemSourceActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_SystemSourceActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    public SystemSourceActions @SystemSource => new SystemSourceActions(this);
    ...
    public interface ISystemSourceActions
    {
